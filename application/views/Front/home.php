...
<head>
  ...
  <title>AdminLTE 2 | Registration Pages</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html" ><b style="color: white;">VICTORY</b> <a style="color: white;">| Register</a></a>
  </div>
  ...
  <div class="register-box-body ">
            ...
            <div class="form-group <?=form_error('agama') ? 'has-error':null?>">
                ...
                <select name="agama" class="form-control">
                    ...
                    <option value="1" <?= set_value('agama') == 1? "selected" : null ?>>
                        Islam
                    </option>
                    <option value="2" <?= set_value('agama') == 2? "selected" : null ?>>
                        Kristen
                    </option>
                    <option value="3" <?= set_value('agama') == 3? "selected" : null ?>>
                        Hindu
                    </option>
                    <option value="4" <?= set_value('agama') == 4? "selected" : null ?>>
                        Budha
                    </option>
                </select>
                <?=form_error('agama') ?>
